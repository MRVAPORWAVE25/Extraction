...
(function(){
  ...
  function showStatusStripIfEntered(){
    try {
      ...
      // Always hide the strip when a fullscreen iframe is present or the body is in search/games view.
      ...
      // Only allow showing the status strip when on the homepage (entered) AND not in any iframe / preview mode.
      // Use location check to be conservative: treat index.html or root as homepage.
